...
import com.genba.jun.veritecpro04.smb.jcifs.*;
import com.genba.jun.veritecpro04.smb.jcifs.netbios.*;
import com.genba.jun.veritecpro04.smb.jcifs.util.*;
import com.genba.jun.veritecpro04.smb.jcifs.util.transport.*;
...
*/
    ...
    protected Request peekKey() throws IOException {
        ...
        if (log.level >= 4) {
            ...
            com.genba.jun.veritecpro04.smb.jcifs.util.Hexdump.hexdump( log, sbuf, 4, 32 );
        }
