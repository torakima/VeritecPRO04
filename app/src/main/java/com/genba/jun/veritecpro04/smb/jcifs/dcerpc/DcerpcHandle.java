...
package com.genba.jun.veritecpro04.smb.jcifs.dcerpc;
...
import com.genba.jun.veritecpro04.smb.jcifs.dcerpc.ndr.NdrBuffer;
...
synchronized (this) {
    ...
    public void sendrecv(DcerpcMessage msg) throws DcerpcException, IOException {
        ...
        stub = com.genba.jun.veritecpro04.smb.jcifs.smb.BufferCache.getBuffer();
        try {
            int off, tot, n;
            ...
            com.genba.jun.veritecpro04.smb.jcifs.smb.BufferCache.releaseBuffer(stub);
        }
