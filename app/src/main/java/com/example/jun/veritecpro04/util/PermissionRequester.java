...
public class PermissionRequester {
    ...
    public static class Builder {
        ...
        private String title = "権限要請";
        private String message = "この機能を使用するためには権限が必要です。";
        private String positiveButtonName = "はい";
        private String negativeButtonName = "いいえ";
