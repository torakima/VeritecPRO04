...
package com.example.jun.veritecpro04.smb.jcifs.dcerpc;
...
import com.example.jun.veritecpro04.smb.jcifs.dcerpc.ndr.NdrBuffer;
...
synchronized (this) {
    ...
    public void sendrecv(DcerpcMessage msg) throws DcerpcException, IOException {
        ...
        stub = com.example.jun.veritecpro04.smb.jcifs.smb.BufferCache.getBuffer();
        try {
            int off, tot, n;
            ...
            com.example.jun.veritecpro04.smb.jcifs.smb.BufferCache.releaseBuffer(stub);
        }
